...
export class AddUpdateUserComponent implements OnInit {
  ...
  public newUser: INewUser = {firstName: '', lastName: '', email: ''}

  constructor(private usersService: UsersService, private router: Router, public route: ActivatedRoute) {
  ...
  public addUpdateUser(): void {
    ...
    if (this.route.snapshot.paramMap.get('firstName')) {
      ...
      this.usersService.updateUser(+this.route.snapshot.paramMap.get('id'), this.newUser).subscribe({
        next: (result) => {
